...
const Navbar = () => {
  ...
  return (
    <div className='container pt-10 font-extrabold '>
        <div className='flex justify-between items-center'>
            <div className='text-6xl font-larger font-serif font-bold '>
               RA
            </div>
        ...
        {
          isMenuOpen && (
            <div className='absolute top-0 right-0 w-full h-full bg-black bg-opacity-70 z-50'>
